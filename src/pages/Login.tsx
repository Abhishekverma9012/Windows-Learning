      ...
      <main className="flex-1 flex items-center justify-center py-16 px-4" style={{ backgroundColor: 'hsl(var(--surface-warm))' }}>
        <div className="w-full max-w-md bg-card rounded-2xl border shadow-card p-8">
          ...
          <div className="space-y-3 mb-6">
            <button className="w-full flex items-center justify-center gap-3 h-11 rounded-lg border hover:bg-secondary transition-colors text-sm font-medium active:scale-[0.98]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full h-11 active:scale-[0.98] transition-all">
              Sign In
            </Button>
          </form>
